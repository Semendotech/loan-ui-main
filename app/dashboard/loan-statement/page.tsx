  ...
  const loadCustomers = async (search = "", nextPage = false) => {
    ...
    try {
      ...
      const params: Record<string, string> = {
        ...
        offset: String(pageToLoad * pageSize),
      };
      if (search.trim()) {
  ...
  return (
    <section className="space-y-6">
      ...
      <div className="space-y-6">
        <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="flex items-end gap-3">
              <button
                type="button"
                onClick={() => loadCustomers(query, false)}
          ...
          {hasMore && !loadingCustomers && customers.length > 0 && (
            <div className="mt-6 flex justify-center">
              <button
                type="button"
                onClick={() => loadCustomers(query, true)}
        ...
        {selectedCustomer && selectedCustomerCard}
